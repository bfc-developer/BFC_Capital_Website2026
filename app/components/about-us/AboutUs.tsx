            ...
            <section className="py-5 md:py-15">
                <div className="container m-auto px-5 md:px-10 lg:px-20">
                    <div className="text-[#44475B] text-justify text-[15px] md:text-[17px] leading-relaxed">
                        ...
                        <p className="mb-5">BFC Capital began its journey over 22+ years ago with a singular focus: to make wealth management accessible, reliable, and insightful for every investor. From the very beginning, we recognized that financial decisions are only as strong as the clarity and knowledge behind them. This understanding has guided us in building services that not only manage assets but also educate and empower investors at every stage of their financial journey.</p>

                        <p className="mb-5">
                            Over the years, BFC Capital has grown to manage over ₹1,000 Crore in assets under advisory, serving more than 17,000 investors. But beyond numbers, our journey is defined by trust– the trust our clients place in us, the expertise our advisors bring, and our commitment to delivering financial clarity.</p>
