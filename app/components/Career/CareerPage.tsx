                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {jobOpenings.map((job, index) => (
                        ...
                        >
                            ...
                            <Link href={`/career/${job.slug}`} className="w-full bg-gray-50 flex items-center justify-center py-2.5 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors group">
