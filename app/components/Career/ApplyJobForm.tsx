            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex items-start gap-4 mt-8">
                    ...
                    <label htmlFor="consent-checkbox" className="text-sm text-[#7A7A7A] leading-relaxed cursor-pointer">
                        I, hereby accord my consent to process my above mentioned personal data by BFC Capital Pvt. Ltd. for the purpose of career and job opportunities, in accordance with the provisions of DPDP Act 2023. To know more <Link href="/privacy-policy#point-5" className="underline text-[#011EFE]" aria-label="Click here to read more about personal data processing details in DPDP Act 2023">click here.</Link>
                    </label>
                </div>
