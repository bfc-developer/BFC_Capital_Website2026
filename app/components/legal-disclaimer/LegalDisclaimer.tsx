...
export default function LegalDisclaimer() {
    return (
        <div className="container mx-auto px-4 py-8 md:py-12 md:px-15 lg:px-20">
            ...
            <div className="text-[11px] md:text-[14px] lg:text-[17px] space-y-6 text-[#44475B] leading-relaxed text-justify">
                <p>
                    If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at <a href="mailto:customersupport@bfccapital.com" className="hover:text-[#001EFE]">customersupport@bfccapital.com</a>
                </p>
            </div>
            ...
            <div className="space-y-6 text-[#44475B] leading-relaxed text-justify  text-[11px] md:text-[14px] lg:text-[17px] leading-relaxed">
                <p>
