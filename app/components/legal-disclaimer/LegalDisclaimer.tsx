    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12 md:px-15 lg:px-20">
            ...
            <div className="text-[15px] md:text-[17px] space-y-6 text-[#44475B] leading-relaxed text-justify">
                <p>
                    If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at <a href="mailto:customersupport@bfccapital.com" className="text-[#001EFE] underline hover:text-[#001EFE]/80 font-medium">customersupport@bfccapital.com</a>
                </p>
            </div>
