    ...
    return (
        <>
                ...
                <div className="container mx-auto px-5 md:px-10 lg:px-20">
                    <div className="flex md:gap-10 flex-col md:flex-row justify-center md:justify-between items-center md:px-3">
                        ...
                        >
                            ...
                            <Link href="https://app.prodigypro.co.in/dashboard" className="bg-[#024B39] text-white px-6 py-2 rounded-md hover:bg-[#024B39] transition duration-300">
                                Invest Now!
                            </Link>
                        </div>
            ...
            <section>
                ...
                <div className='container mx-auto px-5 md:px-10 lg:px-20'>
                    <h3 className="mx-auto mt-4 md:mt-8 mb-4 text-[15px] md:text-[24px] font-bold text-[#44475B] mb-[10px] md:mb-[20px]">
