    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12 md:px-15 lg:px-20">
            ...
            <div className="space-y-6 text-[#44475B] leading-relaxed text-justify">
                <p className="text-justify text-[11px] md:text-[14px] lg:text-[17px] leading-relaxed">
            ...
            <h2 className="text-[13px] md:text-[20px] lg:text-[24px] font-bold mt-8 text-[#44475B] pb-4 mb-4">1. Information Collected</h2>
            <ul className="text-[#44475B] list-disc ml-7 text-justify text-[11px] md:text-[14px] lg:text-[17px] leading-relaxed">
            ...
            <h2 className="text-[13px] md:text-[20px] lg:text-[24px] font-bold mt-8 text-[#44475B] pb-4 mb-4">2. Investment Journey</h2>
            <p className="text-[#44475B] mb-4 text-justify text-[11px] md:text-[14px] lg:text-[17px] leading-relaxed">The following information needs to be provided by “You“ mandatorily and voluntarily, when starting “Your” investment journey on our platforms:</p>
            <ul className="text-[#44475B] list-disc ml-7 text-justify">
            ...
            <h2 className="text-[13px] md:text-[20px] lg:text-[24px] font-bold mt-8 text-[#44475B] pb-4 mb-4">3. KYC Details</h2>
            <p className="text-[#44475B] text-justify text-[11px] md:text-[14px] lg:text-[17px] leading-relaxed">Based on your explicit consent, we may fetch your KYC details from regulatory repositories such as CDSL Ventures Limited (CVL KRA) or other authorized agencies to ensure compliance with applicable laws and regulations.</p>
            <div className="w-24 h-[2] bg-[#011EFE] rounded my-3 md:my-5 lg:my-8"></div>

            <h2 className="text-[13px] md:text-[20px] lg:text-[24px] font-bold mt-8 text-[#44475B] pb-4 mb-4">4. Other Information</h2>
            ...
            <h2 className="text-[13px] md:text-[20px] lg:text-[24px] font-bold mt-8 text-[#44475B] pb-4 mb-4">5. User Data Policy</h2>
            <ul className="text-[#44475B] list-disc ml-7 text-justify text-[11px] md:text-[14px] lg:text-[17px] leading-relaxed">
