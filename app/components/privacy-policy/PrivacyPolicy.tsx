...
export default function PrivacyPolicy() {
    return (
        <div className="container mx-auto px-4 py-8 md:py-12 md:px-45">
            ...
            {/* Content */}
            <div className="space-y-6 text-[#44475B] leading-relaxed">
                <p>
            ...
            <h2 className="text-2xl font-bold mt-8 text-[#44475B] pb-4 mb-4">1. Information Collected</h2>
            <ul className="text-[#44475B] list-disc ml-7">
            ...
            <div className="w-24 h-1 bg-[#011EFE] rounded my-8"></div>

            <h2 className="text-2xl font-bold mt-8 text-[#44475B] pb-4 mb-4">2. Investment Journey</h2>
            <p className="text-[#44475B] mb-4">The following information needs to be provided by “You“ mandatorily and voluntarily, when starting “Your” investment journey on our platforms:</p>
            <ul className="text-[#44475B] list-disc ml-7">
            ...
            <h2 className="text-2xl font-bold mt-8 text-[#44475B] pb-4 mb-4">3. KYC Details</h2>
            <p className="text-[#44475B]  ">Based on your explicit consent, we may fetch your KYC details from regulatory repositories such as CDSL Ventures Limited (CVL KRA) or other authorized agencies to ensure compliance with applicable laws and regulations.</p>
            <div className="w-24 h-1 bg-[#011EFE] rounded my-8"></div>

            <h2 className="text-2xl font-bold mt-8 text-[#44475B] pb-4 mb-4">4. Other Information</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 text-[#44475B] pb-4 mb-4">5. User Data Policy</h2>
            <ul className="text-[#44475B] list-disc ml-7  ">
