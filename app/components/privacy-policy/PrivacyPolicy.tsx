    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12 md:px-15 lg:px-20">
            ...
            <ul className="text-[#44475B] list-disc ml-7 text-justify text-[15px] md:text-[17px] leading-relaxed">
                ...
                <li>Users have the right to request for the correction of their personal data held by "Us". To initiate the data correction process, users can contact us via email at <a href="mailto:dataprotectionbfc@gmail.com" className="text-[#001EFE] underline hover:text-[#001EFE]/80 font-medium">dataprotectionbfc@gmail.com</a> or submit a data correction request through our website using the following link: <a href="https://bfccapital.com/contact-us" target="_blank" rel="noopener noreferrer" className="text-[#001EFE] underline hover:text-[#001EFE]/80 font-medium">https://bfccapital.com/contact-us</a>.</li>
