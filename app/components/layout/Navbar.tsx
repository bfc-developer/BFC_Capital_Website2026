            ...
            <div className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex-shrink-0 flex items-center gap-2">
                    <div className="flex items-center gap-2">
                        <div className="text-2xl font-bold tracking-tight text-red-500">
                            <span className="text-3xl text-red-600">BFC</span> CAPITAL
                        </div>
                    </div>
                </div>
                ...
                <div className="hidden md:flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-1">
                        <span className="text-bfc-blue font-bold text-xl italic">Prodigy</span>
                        <span className="bg-green-500 text-white text-[10px] px-1.5 py-0.5 rounded-sm font-bold uppercase tracking-wider">pro</span>
                    </div>
                </div>
