...
export default function PersonalProfileStep({
    ...
    const handleContinue = async () => {
        ...
        if (!activeData.password || !activeData.password.trim()) {
            validationErrors.password = "Password is required.";
        } else if (activeData.password.length < 6) {
            validationErrors.password = "Password must be at least 6 characters.";
        }

        if (!activeData.confirmPassword || !activeData.confirmPassword.trim()) {
            validationErrors.confirmPassword = "Please confirm your password.";
        } else if (activeData.password !== activeData.confirmPassword) {
        ...
        try {
            const payload = {
                ...
                password: activeData.password || undefined,
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                className={`w-full h-[44px] sm:h-[46px] bg-white border rounded-[10px] px-3 pr-10 text-[13px] text-[#44475b] placeholder-[#8b8b8b] focus:outline-none transition-colors ${errors.password ? "border-red-500 focus:border-red-500" : "border-[#e9e9e9] focus:border-[#06A358]"
                                    }`}
                            ...
                            <button
                                ...
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8b8b8b] hover:text-[#44475b] transition-colors"
                                tabIndex={-1}
                            >
                                {showPassword ? (
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                className={`w-full h-[44px] sm:h-[46px] bg-white border rounded-[10px] px-3 pr-10 text-[13px] text-[#44475b] placeholder-[#8b8b8b] focus:outline-none transition-colors ${errors.confirmPassword ? "border-red-500 focus:border-red-500" : "border-[#e9e9e9] focus:border-[#06A358]"
                                    }`}
