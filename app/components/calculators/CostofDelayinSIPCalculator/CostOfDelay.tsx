                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-6">
                        ...
                        <div className="w-full md:w-1/2">
                            <div className="shadow-md rounded-2xl px-8 py-5 bg-[#FFFFFF]">
                                ...
                                <form onSubmit={(e) => { e.preventDefault(); calculateButton(); }} className="space-y-6">
                                    ...
                                    <button
                                        type="submit"
                                        className="bg-[#024B39] text-white py-3 rounded-lg font-semibold p-[14px] cursor-pointer"
                                    >
                                        Check Impact
                                    </button>
