...
export default function Marriagecalculators() {
    ...
    return (
        <>
                                ...
                                <form className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            min={0}
                                            onChange={(e) =>
                                                setChildAge(parseFloat(e.target.value))
                                            }
                                            placeholder="₹ 10,000"
                                        />
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="shadow-md rounded-2xl px-5 py-4 bg-[#FFFFFF]">
                                    ...
                                    <p className="font-primary text-base md:text-lg leading-relaxed text-textdark">
                                        If you invest{" "}
                                        <strong>₹{childAge.toLocaleString("en-IN")}</strong>{" "}
                                        per month for a period of{" "}
                                        <strong>{marriageAge} years</strong>, your investment
                                        amount will be{" "}
                                        <strong>
                                            ₹{childAge.toLocaleString("en-IN")}
                                        </strong>{" "}
            ...
            <section>
                <h2 className="text-center text-[20px] md:text-3xl lg:text-5xl font-bold text-[#44475B] mt-16">All You Need To Know About <br></br>
