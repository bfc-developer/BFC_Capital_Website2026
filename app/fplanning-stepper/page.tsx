...
export default function FplanningStepper() {
    ...
    const handleResumeSubmit = async (e: React.FormEvent) => {
        ...
        if (!resumePassword || resumePassword.length < 6) {
            setSessionError("Please enter your password (min. 6 characters).");
            return;
        }
            ...
            <div className="relative min-h-screen bg-white overflow-x-hidden font-sans flex items-center justify-center py-10 px-4">
                ...
                <div className="w-full max-w-[500px] bg-white border border-[#e0dbdb] rounded-[24px] sm:rounded-[33px] shadow-[0px_10px_30px_rgba(0,0,0,0.08)] p-6 sm:p-10 text-center space-y-6 relative overflow-hidden">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-[13px] sm:text-[14px] text-[#8b8b8b] font-medium">
                            Enter the mobile number, PAN, and password associated with your previous session.
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full h-[48px] bg-white border border-[#e9e9e9] rounded-[10px] px-4 pr-10 text-[14px] text-[#44475b] placeholder-[#8b8b8b] focus:outline-none focus:border-[#06A358] transition-colors"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowResumePassword(!showResumePassword)}
