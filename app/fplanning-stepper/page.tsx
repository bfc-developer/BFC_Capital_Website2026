...
function ExistingInvestmentsStep({ footer }: { footer?: ReactNode }) {
...
function GoalIdentificationStep({ footer }: { footer?: ReactNode }) {
...
function PortfolioReview({ footer }: { footer?: ReactNode }) {
    return (
        <div className="space-y-6 sm:space-y-8">
            <h2 className="text-[16px] sm:text-[17px] lg:text-[18px] font-medium text-[#44475b]">Testing Step</h2>
            {footer ?? null}
